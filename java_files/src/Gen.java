...
LLE.add_elem(new AddDefs(LLE.add_elem(new Pair("succ",
...
LLE.add_elem(new Return(),LLE.empty())))))))),LLE.empty())), LLE.add_elem(new Pair("iter",
LLE.add_elem(new Cur(
LLE.add_elem(new Cur(
LLE.add_elem(new Push(),
LLE.add_elem(new Push(),
...
LLE.add_elem(new Return(),LLE.empty()))))))))))))))))))))))))),
LLE.add_elem(new Return(),LLE.empty())))))))))),
LLE.add_elem(new Return(),LLE.empty()))),LLE.empty())), LLE.add_elem(new Pair("ack",
LLE.add_elem(new Cur(
LLE.add_elem(new Push(),
LLE.add_elem(new Push(),
LLE.add_elem(new Snd(),
...
LLE.add_elem(new Cons(),
LLE.add_elem(new App(),
LLE.add_elem(new RmDefs(3), LLE.empty())))))))))))));
}